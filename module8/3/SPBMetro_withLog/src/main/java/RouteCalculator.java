...
public class RouteCalculator
{
    ...
    public List<Station> getShortestRoute(Station from, Station to)
    {
        ...
        if(route != null && route.size() > 0) { // поправлено условие
            return route;
        }
...
//=============================== Обертки для тестирования приватных методов =========================================
    public List<Station> getGetRouteOnTheLine (Station from, Station to) {
        return getRouteOnTheLine(from, to);
    }

    public List<Station> getGetRouteWithOneConnection (Station from, Station to) {
        return getRouteWithOneConnection(from, to);
    }

    public List<Station> getGetRouteWithTwoConnections (Station from, Station to) {
        return getRouteWithTwoConnections(from, to);
    }

    public Boolean getIsConnected(Station station1, Station station2) {
        return isConnected(station1, station2);
    }

    public List <Station> getGetRouteViaConnectedLine (Station from, Station to) {
        return getRouteViaConnectedLine (from, to);
    }
//--------------------------------------------------------------------------------------------------------------------
