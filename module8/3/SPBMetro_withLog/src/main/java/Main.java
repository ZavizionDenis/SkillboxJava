...
public class Main
{
    private static Logger emptyStationLogger = LogManager.getLogger("EmptyStation");
    private static Logger requestStationLogger = LogManager.getLogger("RequestStation");
    private static Logger errorLogLogger = LogManager.getLogger("ErrorLog");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            ...
            requestStationLogger.info("fromStation: " + from + " toStation: " + to);
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            emptyStationLogger.info("Станция: " + line + " отсутсвует");
    ...
    private static void parseConnections(JSONArray connectionsArray)
    {
        connectionsArray.forEach(connectionObject ->
        {
            ...
            connection.forEach(item ->
            {
                ...
                if(station == null)
                {
                    String exText = "core.Station " +
                            stationName + " on line " + lineNumber + " not found";
                    errorLogLogger.error(exText);
